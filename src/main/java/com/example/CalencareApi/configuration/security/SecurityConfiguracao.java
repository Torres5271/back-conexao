package com.example.CalencareApi.configuration.security;

import com.example.CalencareApi.configuration.security.jwt.GerenciadorTokenJwt;
import com.example.CalencareApi.service.AutenticacaoService;
...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/funcionarios-op/login","POST"),
            new AntPathRequestMatcher("/funcionarios-op","POST"),
            ...
            new AntPathRequestMatcher("/horarios-funcionamento/**"),
            new AntPathRequestMatcher("/calendar/**"),
            new AntPathRequestMatcher("/**"),
            new AntPathRequestMatcher("/categoria-despesa/**"),
            new AntPathRequestMatcher("/despesas/**"),
            new AntPathRequestMatcher("/categoria-servico/**"),
            new AntPathRequestMatcher("/dashboard/**"),
            new AntPathRequestMatcher("/pdfs/**"),
            new AntPathRequestMatcher("/agendamentos/csv"),
    };
